...
-- Started on 2016-12-02 10:18:46 +0530
...
--
-- TOC entry 318 (class 1259 OID 393518)
...
--
-- TOC entry 348 (class 1259 OID 401431)
...
--
-- TOC entry 2516 (class 2604 OID 401433)
...
--
-- TOC entry 2635 (class 0 OID 393518)
-- Dependencies: 318
...
SELECT pg_catalog.setval('dmf_da_structure_id_seq', 1, false);


--
-- TOC entry 2518 (class 2606 OID 401441)
...
--
-- TOC entry 2520 (class 2606 OID 393524)
-- Name: fk_district_dmf_da_structure; Type: FK CONSTRAINT; Schema: health; Owner: postgres
--

ALTER TABLE ONLY dmf_da_structure
    ADD CONSTRAINT fk_district_dmf_da_structure FOREIGN KEY (district) REFERENCES public.district(id);


--
-- TOC entry 2519 (class 2606 OID 401284)
-- Name: fk_incident_dmf_da_structure; Type: FK CONSTRAINT; Schema: health; Owner: postgres
--

ALTER TABLE ONLY dmf_da_structure
    ADD CONSTRAINT fk_incident_dmf_da_structure FOREIGN KEY (incident) REFERENCES public.incident_report(id);


-- Completed on 2016-12-02 10:18:46 +0530
