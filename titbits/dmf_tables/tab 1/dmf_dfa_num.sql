...
-- Started on 2016-12-02 10:17:02 +0530
...
--
-- TOC entry 346 (class 1259 OID 401415)
...
--
-- TOC entry 2516 (class 2604 OID 401417)
...
--
-- TOC entry 2635 (class 0 OID 393496)
-- Dependencies: 316
...
SELECT pg_catalog.setval('dmf_dfa_num_id_seq', 1, false);


--
-- TOC entry 2518 (class 2606 OID 401422)
...
--
-- TOC entry 2520 (class 2606 OID 393502)
...
--
-- TOC entry 2519 (class 2606 OID 401274)
-- Name: fk_incident_dmf_dfa_num; Type: FK CONSTRAINT; Schema: health; Owner: postgres
--

ALTER TABLE ONLY dmf_dfa_num
    ADD CONSTRAINT fk_incident_dmf_dfa_num FOREIGN KEY (incident) REFERENCES public.incident_report(id);


-- Completed on 2016-12-02 10:17:03 +0530
