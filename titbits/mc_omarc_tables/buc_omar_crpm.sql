...
-- Started on 2016-12-01 16:11:15 +0530
...
--
-- TOC entry 310 (class 1259 OID 393441)
...
--
-- TOC entry 311 (class 1259 OID 393452)
...
--
-- TOC entry 2372 (class 2604 OID 393454)
...
--
-- TOC entry 2490 (class 0 OID 393441)
-- Dependencies: 310
...
SELECT pg_catalog.setval('buc_omarc_crpm_id_seq', 1, false);


--
-- TOC entry 2374 (class 2606 OID 393462)
...
--
-- TOC entry 2375 (class 2606 OID 393447)
-- Name: fk_district_buc_omarc_crpm; Type: FK CONSTRAINT; Schema: health; Owner: postgres
--

ALTER TABLE ONLY buc_omarc_crpm
    ADD CONSTRAINT fk_district_buc_omarc_crpm FOREIGN KEY (district) REFERENCES public.district(id);


-- Completed on 2016-12-01 16:11:15 +0530
